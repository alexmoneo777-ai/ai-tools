...
- [Claude Code Bridge](https://github.com/bfly123/claude_code_bridge) - Real-time multi-AI collaboration between Claude, Codex and Gemini in terminal with minimal token overhead.
