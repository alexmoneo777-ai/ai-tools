...
- [Super Claude Kit](https://github.com/arpitnath/super-claude-kit) - Transform Claude Code from stateless to stateful. Persistent context memory system with cross-session persistence, token-efficient storage, and zero dependencies.
