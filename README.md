...
- [EthGasOptimizer (EGO)](https://ethgasoptimizer.com) - Ethereum gas optimization tool that predicts cheaper network windows and automates transaction broadcasting using meta-transaction flows (EIP-2771).
