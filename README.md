...
- [Contextcalc](https://github.com/agentinit/contextcalc) - Tree-like CLI tool that displays file structures with token counts for better LLM context management. Open source MIT license.
