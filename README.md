...
- [AnyLLM](https://github.com/mozilla-ai/any-llm) - Open-source Python SDK providing a single consistent interface for multiple LLM providers (OpenAI, Mistral, Ollama, etc.).
